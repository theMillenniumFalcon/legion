...
const applyQueryParams = (apiUrl: string, query: QueryParams) => {
    ...
    // Direct toString() is not used as it encodes the special characters, making URL harder to read
...
const ApiRoutePage = ({ apiRoute }: Props) => {
    ...
    const syncUrlAndQueryParams = useCallback((_: any, { name, type }) => {
                        ...
                        <Flex flex="1" flexDirection="column" position="relative" mt="2">
                            <Flex alignItems="center">
                                ...
                                <Flex position="relative" zIndex="10" alignItems="center" width="100%">
                                    ...
                                    {isRateLimitingEnabled && <MiddlewareCard>Rate Limiting</MiddlewareCard>}
