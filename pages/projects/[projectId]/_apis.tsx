...
const Apis: React.FC<apisProps> = ({ project, ...props }) => {
    ...
    const deleteApi = async (e: any, apiId: string, apiName: string) => {
        e.stopPropagation()
    ...
    const openDuplicateApiModal = async (e: any, api: ApiRoute) => {
        e.stopPropagation()
